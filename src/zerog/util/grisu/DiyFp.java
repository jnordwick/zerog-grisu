...
/*
 * Lack of stack-based storage in Java is a real killer sometimes.
 * I'll include the DiyFp methods just to make things clearer, but
 * we use static native-number based methods to avoid the allocations
 * or bringing in a memory pool for such a minor thing.
 * 
 * Sorry about this :(
 */
